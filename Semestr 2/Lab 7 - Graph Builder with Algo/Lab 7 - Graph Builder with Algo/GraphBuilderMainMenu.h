...
namespace Lab7GraphBuilderwithAlgo {
	...
	private: System::Windows::Forms::ToolStripMenuItem^ ÔÓ¯ÛÍ¬ÿËËÌÛToolStripMenuItem;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->ÔÓ¯ÛÍ¬ÿËËÌÛToolStripMenuItem = (gcnew System::Windows::Forms::ToolStripMenuItem());
			...
			this->algoMode->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(3) {
				this->dfsAlgoMode,
					this->ÔÓ¯ÛÍ¬ÿËËÌÛToolStripMenuItem, this->topologicalSortAlgoMode
			});
			...
			// 
			// ÔÓ¯ÛÍ¬ÿËËÌÛToolStripMenuItem
			// 
			this->ÔÓ¯ÛÍ¬ÿËËÌÛToolStripMenuItem->Name = L"ÔÓ¯ÛÍ¬ÿËËÌÛToolStripMenuItem";
			resources->ApplyResources(this->ÔÓ¯ÛÍ¬ÿËËÌÛToolStripMenuItem, L"ÔÓ¯ÛÍ¬ÿËËÌÛToolStripMenuItem");
			// 
